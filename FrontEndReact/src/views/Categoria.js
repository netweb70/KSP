...
import { urlCategoriaGuardar } from "./endpoints.js";
import { urlCategoriaEditar } from "./endpoints.js";
import { urlCategoriaEliminar } from "./endpoints.js";
...
const Categoria = () => {
    ...
    const guardarCambios = async () => {
        ...
        if (categoria.idCategoria == 0) {
            response = await fetch(urlCategoriaGuardar, {
                method: 'POST',
                headers: {
            ...
            response = await fetch(urlCategoriaEditar, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json;charset=utf-8'
                },
    ...
    const eliminarCategoria = async(id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const response = fetch(urlCategoriaEliminar + "/" + id, { method: "DELETE" })
                    .then( response => {
                        if (response.ok) {
